...
class DataTransformation:
    ...
    def initiate_data_transofrmation(self,train_path,test_path):
        ...
        try:
            ...
            logging.info('redaing train and test data completed')
            ...
            logging.info('appying preprocessing object on training and testing dataframe')
            ...
            logging.info('save preprocessing onject')
